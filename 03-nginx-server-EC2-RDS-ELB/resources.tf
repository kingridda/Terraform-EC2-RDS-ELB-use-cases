...
resource "aws_instance" "myserver" {
  ...
  provisioner "remote-exec" {
    inline = [
      "sudo yum install nginx mysql php php-mysql -y", #u only need php and php-mysql. I installed mysql only to ssh and manipilate database as I wish :)
...
resource "aws_db_instance" "default" {
  ...
  # use these provisioners to configure/upload scripts...
  # provisioner "file" {
  #   #nested connection
  #   connection {
  #     type        = "ssh"
...
### Used to Manage the MySQL configuration charset and stuff
